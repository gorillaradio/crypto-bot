...
| 6 — Brain a due stadi | 📝 piano scritto | [2026-07-04-brain-due-stadi](2026-07-04-brain-due-stadi.md) | analyst+trader dietro flag `brain_version`; design [specs/2026-07-04-brain-due-stadi-design](../specs/2026-07-04-brain-due-stadi-design.md); **vista market brief → Fase 7** (deciso 4 lug) |
