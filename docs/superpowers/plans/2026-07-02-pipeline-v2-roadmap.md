...
| 7 — UI di completamento | 📝 piano scritto | [2026-07-04-ui-completamento](2026-07-04-ui-completamento.md) | 10 task TDD (4 backend + 5 frontend + finaliz.); endpoint di lettura (P&L per posizione **autorevole**, feed **osservazioni** globale, **market brief** per-agente filtrato) + pannello **decisioni** + `brain_version` esposto/badge; **zero migrazioni** (single head `49407193a9ac` invariata); design [specs/2026-07-04-ui-completamento-design](../specs/2026-07-04-ui-completamento-design.md) |
